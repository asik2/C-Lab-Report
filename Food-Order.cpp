...
int main()
{
    ...
    {
        new Student("Pulak","20-6-1996",department,"1001"),
        new Student("Evan","13-3-1998",department,"1002"),
        new Student("Ayon","21-11-1996",department,"1003"),
        new Student("Uzzal","05-07-1997",department,"1004")
    };

    Sellsman sells_person("Jawad Shafi","13-03-1985",1);
